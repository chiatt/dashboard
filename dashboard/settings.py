...
DATATYPE_LOCATIONS.append("dashboard.datatypes")
FUNCTION_LOCATIONS.append("dashboard.functions")
ETL_MODULE_LOCATIONS.append("dashboard.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("dashboard.search_components")
...
SECRET_KEY = "j23t2iq@!4ud*etavhxcplan^%zokht960bik4fnarjddlm5u+"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "dashboard.urls"
ROOT_HOSTCONF = "dashboard.hosts"
...
ELASTICSEARCH_PREFIX = "dashboard"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'dashboard.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "dashboard",  # Ensure the project is listed before any other arches applications
)
